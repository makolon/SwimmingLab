...
from swimlab.controllers import LeeControllerCfg
from swimlab.envs.mdp.actions import lee_actions


@configclass
class LeeActionCfg(ActionTermCfg):
    """Config for velocity + yaw rate action mapped through LeePositionController."""
    class_type: type[ActionTerm] = lee_actions.LeeAction
    ...
    controller: LeeControllerCfg = MISSING
    """The configuration for the lee controller."""
