...
from swimlab_scenes.warehouse_scene_cfg import WarehouseSceneCfg
from swimlab_tasks.object_goal_navigation.object_goal_navigation_env_cfg import ObjectGoalNavigationBaseEnvCfg
...
@configclass
class HummingBirdWarehouseObjectGoalNavigationEnvCfg(ObjectGoalNavigationBaseEnvCfg):
    """Configuration for the object goal navigation environment."""

    # scene settings
    scene: WarehouseSceneCfg = WarehouseSceneCfg(num_envs=4096, env_spacing=3.0)

    # viewer settings
    viewer: ViewerCfg = ViewerCfg(eye=(2.0, 2.0, 2.0), lookat=(0.0, 0.0, 0.0))
...
@configclass
class HummingBirdWarehouseObjectGoalNavigationEnvCfg_PLAY(HummingBirdWarehouseObjectGoalNavigationEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
