...
@configclass
class FireFlyWarehouseObjectGoalNavigationEnvCfg(ObjectGoalNavigationBaseEnvCfg):
...
@configclass
class FireFlyWarehouseObjectGoalNavigationEnvCfg_PLAY(FireFlyWarehouseObjectGoalNavigationEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
