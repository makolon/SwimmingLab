...
@configclass
class HummingBirdLivingRoomObstacleNavigationEnvCfg(ObstacleNavigationBaseEnvCfg):
...
@configclass
class HummingBirdLivingRoomObstacleNavigationEnvCfg_PLAY(HummingBirdLivingRoomObstacleNavigationEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a scene for play
