...
from isaaclab.utils.math import compute_pose_error, quat_from_euler_xyz, quat_unique

if TYPE_CHECKING:
    from isaaclab.envs import ManagerBasedEnv

    from .commands_cfg import TargetPoseCommandCfg
...
class TargetPoseCommand(CommandTerm):
    ...
    def __init__(self, cfg: TargetPoseCommandCfg, env: ManagerBasedEnv):
