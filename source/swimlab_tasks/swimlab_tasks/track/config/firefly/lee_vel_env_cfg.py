...
@configclass
class FireFlyPlaneTrackEnvCfg(TrackBaseEnvCfg):
...
@configclass
class FireFlyLivingRoomTrackEnvCfg(TrackBaseEnvCfg):
...
@configclass
class FireFlyPlaneTrackEnvCfg_PLAY(FireFlyPlaneTrackEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FireFlyLivingRoomTrackEnvCfg_PLAY(FireFlyLivingRoomTrackEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a scene for play
