...
@configclass
class HummingBirdPlaneTrackEnvCfg(TrackBaseEnvCfg):
...
@configclass
class HummingBirdLivingRoomTrackEnvCfg(TrackBaseEnvCfg):
...
@configclass
class HummingBirdPlaneTrackEnvCfg_PLAY(HummingBirdPlaneTrackEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class HummingBirdLivingRoomTrackEnvCfg_PLAY(HummingBirdLivingRoomTrackEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a scene for play
